...
class FillPermissionsForProfesor extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForProfesor constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.profesor',
            'admin.profesor.index',
            'admin.profesor.create',
            'admin.profesor.show',
            'admin.profesor.edit',
            'admin.profesor.delete',
            'admin.profesor.bulk-delete',
        ]);
