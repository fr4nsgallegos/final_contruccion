...
class UpdateSemestreAcademico extends FormRequest
{
    ...
    {
        return [
            'nombre_semestre' => ['sometimes', Rule::unique('Semestre_Academico', 'nombre_semestre')->ignore($this->semestreAcademico->getKey(), $this->semestreAcademico->getKeyName()), 'string'],
