...
class UpdateMallaAcademica extends FormRequest
{
    ...
    {
        return [
            'nombre_malla_academica' => ['sometimes', Rule::unique('Malla_Academica', 'nombre_malla_academica')->ignore($this->mallaAcademica->getKey(), $this->mallaAcademica->getKeyName()), 'string'],
