...
class UpdateCursoAcademico extends FormRequest
{
    ...
    {
        return [
            'nombre_curso_academico' => ['sometimes', Rule::unique('Curso_Academico', 'nombre_curso_academico')->ignore($this->cursoAcademico->getKey(), $this->cursoAcademico->getKeyName()), 'string'],
