...
class FillPermissionsForDiaSemana extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForDiaSemana constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.dia-semana',
            'admin.dia-semana.index',
            'admin.dia-semana.create',
            'admin.dia-semana.show',
            'admin.dia-semana.edit',
            'admin.dia-semana.delete',
            'admin.dia-semana.bulk-delete',
        ]);
