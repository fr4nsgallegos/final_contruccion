...
class FillPermissionsForAnioAcademico extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAnioAcademico constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.anio-academico',
            'admin.anio-academico.index',
            'admin.anio-academico.create',
            'admin.anio-academico.show',
            'admin.anio-academico.edit',
            'admin.anio-academico.delete',
            'admin.anio-academico.bulk-delete',
        ]);
