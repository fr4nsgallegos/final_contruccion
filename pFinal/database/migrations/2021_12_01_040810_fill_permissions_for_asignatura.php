...
class FillPermissionsForAsignatura extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForAsignatura constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.asignatura.create',
            'admin.asignatura.show',
            'admin.asignatura.edit',
            'admin.asignatura.delete',
            'admin.asignatura.bulk-delete',
        ]);
