...
class FillPermissionsForCursoAcademico extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForCursoAcademico constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.curso-academico',
            'admin.curso-academico.index',
            'admin.curso-academico.create',
            'admin.curso-academico.show',
            'admin.curso-academico.edit',
            'admin.curso-academico.delete',
            'admin.curso-academico.bulk-delete',
        ]);
