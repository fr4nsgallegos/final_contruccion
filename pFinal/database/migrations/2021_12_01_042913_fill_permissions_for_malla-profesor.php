...
class FillPermissionsForMallaProfesor extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMallaProfesor constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.malla-profesor',
            'admin.malla-profesor.index',
            'admin.malla-profesor.create',
            'admin.malla-profesor.show',
            'admin.malla-profesor.edit',
            'admin.malla-profesor.delete',
            'admin.malla-profesor.bulk-delete',
        ]);
