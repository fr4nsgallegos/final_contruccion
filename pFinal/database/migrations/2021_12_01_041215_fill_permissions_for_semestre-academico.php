...
class FillPermissionsForSemestreAcademico extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSemestreAcademico constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            ...
            'admin.semestre-academico.index',
            'admin.semestre-academico.create',
            'admin.semestre-academico.show',
            'admin.semestre-academico.edit',
            'admin.semestre-academico.delete',
            'admin.semestre-academico.bulk-delete',
        ]);
