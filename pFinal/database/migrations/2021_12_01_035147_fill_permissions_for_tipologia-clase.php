...
class FillPermissionsForTipologiaClase extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTipologiaClase constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.tipologia-clase',
            'admin.tipologia-clase.index',
            'admin.tipologia-clase.create',
            'admin.tipologia-clase.show',
            'admin.tipologia-clase.edit',
            'admin.tipologia-clase.delete',
            'admin.tipologia-clase.bulk-delete',
        ]);
