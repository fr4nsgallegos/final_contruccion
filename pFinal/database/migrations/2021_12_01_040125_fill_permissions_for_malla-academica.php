...
class FillPermissionsForMallaAcademica extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMallaAcademica constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.malla-academica',
            'admin.malla-academica.index',
            'admin.malla-academica.create',
            'admin.malla-academica.show',
            'admin.malla-academica.edit',
            'admin.malla-academica.delete',
            'admin.malla-academica.bulk-delete',
        ]);
