                            ...
                            <table class="table table-hover table-listing">
                                <thead>
                                    <tr>
                                        ...
                                        <th is='sortable' :column="'dni'">{{ trans('admin.admin-user.columns.dni') }}</th>
                                        <th is='sortable' :column="'usuario'">{{ trans('admin.admin-user.columns.usuario') }}</th>
                                        ...
                                        <th is='sortable' :column="'last_login_at'">{{ trans('Activado') }}</th>
