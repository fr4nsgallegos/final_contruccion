...
class FillPermissionsForLocalTipologium extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForLocalTipologium constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.local-tipologium',
            'admin.local-tipologium.index',
            'admin.local-tipologium.create',
            'admin.local-tipologium.show',
            'admin.local-tipologium.edit',
            'admin.local-tipologium.delete',
            'admin.local-tipologium.bulk-delete',
        ]);
