...
class FillPermissionsForMallaCurso extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForMallaCurso constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.malla-curso',
            'admin.malla-curso.index',
            'admin.malla-curso.create',
            'admin.malla-curso.show',
            'admin.malla-curso.edit',
            'admin.malla-curso.delete',
            'admin.malla-curso.bulk-delete',
        ]);
