...
class FillPermissionsForSesionClase extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForSesionClase constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.sesion-clase',
            'admin.sesion-clase.index',
            'admin.sesion-clase.create',
            'admin.sesion-clase.show',
            'admin.sesion-clase.edit',
            'admin.sesion-clase.delete',
            'admin.sesion-clase.bulk-delete',
        ]);
